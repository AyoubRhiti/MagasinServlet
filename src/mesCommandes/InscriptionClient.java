...
public class InscriptionClient extends HttpServlet {
 ...
 Cookie[] mesCookies = request.getCookies(); // Je récupère tous les cookies if (mesCookies!=null) 
 ...
 // Cas 2 : cas où il n'y a pas de cookies mais les paramètres nom et mot de passes sont présents : 
	 ...
	 /*motPasseCookie = Identification.chercheNom(MotdepasseCookie);
	 nomCookie = Identification.chercheNom(NomCookies);*/
	 //nomCookie = NomCookie.getValue();
	 //motPasseCookie = MotdepasseCookie.getValue();
